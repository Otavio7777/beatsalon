...
export default function DashboardLayout({ children }) {
  ...
  const sb = {
    ...
    brandSg: { fontSize:10, color:'rgba(255,255,255,0.35)', marginTop:3 },
  ...
  return (
    <div style={sb.wrap}>
      <aside style={sb.sidebar}>
          ...
          {navItems.map(item => {
            ...
            return (
              <Link href={item.href} key={item.href} style={{
                ...
                cursor:'pointer', borderRadius:6, margin:'1px 0',
        ...
        <div style={sb.logout}>
          <button style={sb.logoutBtn} onClick={logout}><span>🚪</span> Sair</button>
        </div>
      </aside>
